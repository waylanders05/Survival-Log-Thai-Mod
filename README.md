...
แพ็กเกจนี้รองรับเกม Survival Log เวอร์ชัน 1.0.15690

ดาวน์โหลดรุ่นล่าสุด: [Survival_Log_Thai_1.0.15690.zip](https://github.com/waylanders05/Survival-Log-Thai-Mod/releases/download/v1.0.15690/Survival_Log_Thai_1.0.15690.zip)
...
ใน ZIP มีโฟลเดอร์ `Manual` สำหรับเกมเวอร์ชัน 1.0.15690 โดยเตรียมโครงสร้างไฟล์ให้ตรงกับโฟลเดอร์เกมแล้ว
...
วิธี Manual นี้เป็นไฟล์ที่เตรียมตามโครงสร้างเกมรุ่น 1.0.15690 เท่านั้น หากเกมอัปเดตอีกครั้งควรใช้ ZIP รุ่นใหม่ และไม่ควรนำไฟล์จากโฟลเดอร์ `Manual` ไปใช้กับเกมคนละเวอร์ชัน
